...
MWCCEPPC = dep("Elements/CustomCodePatching/deps/CodeWarrior/mwcceppc.exe", "CodeWarrior compiler")
KAMEK = dep("Elements/CustomCodePatching/deps/Kamek/Kamek.exe", "Kamek linker")
SYMBOLS = dep("Elements/CustomCodePatching/symbols", "Symbols folder")
...
def build(region: str):
    compile_cmd = f"{MWCCEPPC} -c -Cpp_exceptions off -nodefaults -proc gekko -fp hard -lang=c++ -O4,s -inline on " \
                  ...
                  f"-i include -I- -i loader -D{region} Elements/CustomCodePatching/loader/loader.cpp -o Elements/CustomCodePatching/loader/loader.o"

    kamek_cmd = f"{KAMEK} Elements/CustomCodePatching/loader/loader.o -static=0x80001800 -externals={SYMBOLS}/{region}.txt " \
